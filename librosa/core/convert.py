...
def tuning_to_A4(
    tuning: _FloatLike_co, *, bins_per_octave: int = 12
) -> np.floating[Any]:
    # Assume A4 frequency is 440 Hz
    A4_FREQ = 440.0

    # Efficiently calculate the tuning frequency
    # Using 2 ** (tuning / bins_per_octave) for fast computation
    exponent = tuning / bins_per_octave
    return np.float64(A4_FREQ * 2**exponent)
